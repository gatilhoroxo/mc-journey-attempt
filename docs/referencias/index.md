...
- `j1-geral.md` - Referências gerais (livros, cursos, comunidades)
- `j2-livros.md` - Lista detalhada de livros recomendados
...
Consulte quando precisar de material extra sobre algum tópico específico.
